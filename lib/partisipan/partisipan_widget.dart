...
import 'partisipan_model.dart';
export 'partisipan_model.dart';

class PartisipanWidget extends StatefulWidget {
  const PartisipanWidget({
    super.key,
  ...
  static String routeName = 'Partisipan';
  static String routePath = '/partisipan';

  @override
  State<PartisipanWidget> createState() => _PartisipanWidgetState();
}

class _PartisipanWidgetState extends State<PartisipanWidget> {
  late PartisipanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PartisipanModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<KelasRecord>(
      stream: KelasRecord.getDocument(widget.kelasRef!),
      builder: (context, snapshot) {
        ...
        final partisipanKelasRecord = snapshot.data!;
                  ...
                  Column(
                    ...
                    children: [
                      wrapWithModel(
                        ...
                        updateCallback: () => safeSetState(() {}),
                        child: FooterMenuWidget(
                          parameter2: partisipanKelasRecord.reference,
                        ),
                      ),
                    ],
                  ),
